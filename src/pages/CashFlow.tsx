  ...
  return (
    <div className="space-y-4 sm:space-y-6">
      ...
      <div className="space-y-1">
        <h1 className="text-2xl sm:text-3xl font-bold text-foreground">Fluxo de Caixa</h1>
        <p className="text-sm sm:text-base text-muted-foreground">Controle de entradas e saídas financeiras</p>
      </div>
